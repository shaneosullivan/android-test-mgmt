...
const ENV_VARS: EnvVarConfig[] = [
  ...
  },
  {
    ...
    description: 'Service account for managing Google Groups across all registered Android apps.',
    instructions: {
      title: 'Setup:',
      steps: [
  ...
  },
  {
    ...
    description: 'Private key for the Google Groups service account (PEM format).',
    instructions: {
      title: 'Setup:',
      steps: [
  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        <h1>{allConfigured ? '✅' : '⚠️'} Service Configuration {allConfigured ? 'Complete' : 'Required'}</h1>
        <p>
          {allConfigured 
      ...
      <section className={styles.section}>
        ...
        <p>Configure these credentials once to enable the service to manage Google Groups and store data for all Android apps that sign up:</p>

        {envStatus.map(envVar => (
          <div key={envVar.name} className={`${styles.envVar} ${envVar.isConfigured ? styles.configured : styles.notConfigured}`}>
            <h3>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.setupStep}>
              ...
              <ul>
                ...
                <li>Set up Google Workspace Admin access for the service account</li>
              </ul>
            </div>
